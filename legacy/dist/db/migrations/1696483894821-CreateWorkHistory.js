...
exports.CreateWorkHistory1696483894821 = void 0;
class CreateWorkHistory1696483894821 {
    constructor() {
        this.name = 'CreateWorkHistory1696483894821';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "work_history" ("id" SERIAL NOT NULL, \
...
CONSTRAINT "PK_0c1d1173396df573362f803108d" PRIMARY KEY ("id"));`);
        await queryRunner.query(`INSERT INTO "work_history" ("company", "position", "startDate", "endDate", "description") \
...
exports.CreateWorkHistory1696483894821 = CreateWorkHistory1696483894821;
//# sourceMappingURL=1696483894821-CreateWorkHistory.js.map